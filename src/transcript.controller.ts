...
export class TranscriptController{
   ...
   // @UseInterceptors(AnyFilesInterceptor())
    ...
    async transcribe(@Req() req: Request, @Res({ passthrough: true }) res: Response, @UploadedFile() file: Express.Multer.File): Promise<string>{ //@UploadedFiles() files: Array<Express.Multer.File>,
      try {
         //    const bufferStream = new PassThrough();
            ...
            const command: typeof FfmpegCommand = FfmpegCommand()
                .input(bufferStream)
                .inputFormat(contentType).audioFrequency(48000)
                .outputFormat("flac")
                .audioCodec("flac");
          ...
          */
            ...
            return new Promise<string>((resolve, reject) => {
              command.on('end', () => {
                  ...
                  trancriber.transcribe(streamifier.createReadStream(processedData))
