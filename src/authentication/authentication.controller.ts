...
export class AuthenticationController {
  ...
  @Redirect('instantmorse.codes/static/authenticationPage', 301) //sample redirection - can redirect back to the authentication page if the user or pass is wrong
